...
class KEGGHandler:
    ...
    def parse_pathway_data(self, kegg_data):
        ...
        #### How does the kegg data look like? CAn you give an example?
        for line in kegg_data.split("\n"):
            if line.startswith("GENE"):
                parts = line.split()
                #### Because I have no idea which data the parameter kegg_data can contain,
                #### I do not understand why it is parts[1] instead of parts[0] in the line below.
                #### The same problem holds for the code in the elif statement.
            ...
            #### Because I have no idea which data the parameter kegg_data can contain,
            #### I do not understand why it is related_pathways[0], related_pathways[1]
